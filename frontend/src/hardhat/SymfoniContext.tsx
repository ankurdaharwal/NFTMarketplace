...
export const NFTMarketplaceContext = React.createContext<SymfoniNFTMarketplace>(
  emptyContract
);
export const NFTMarketplaceStorageContext = React.createContext<SymfoniNFTMarketplaceStorage>(
  emptyContract
);
export const PaymentTokenContext = React.createContext<SymfoniPaymentToken>(
  emptyContract
);
...
export const Symfoni: React.FC<SymfoniProps> = ({
  ...
  const [NFTMarketplace, setNFTMarketplace] = useState<SymfoniNFTMarketplace>(
    emptyContract
  );
  const [
    NFTMarketplaceStorage,
    setNFTMarketplaceStorage,
  ] = useState<SymfoniNFTMarketplaceStorage>(emptyContract);
  const [PaymentToken, setPaymentToken] = useState<SymfoniPaymentToken>(
    emptyContract
  );
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const doAsync = async () => {
      ...
      setLoading(true);
      setMessages((old) => [...old, "Initiating Marketplace React"]);
      ...
      return finishWithContracts(
        "Completed Marketplace context initialization."
      );
    };
    doAsync();
    return () => {
